...
const ChangePassword = () => {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${"https://localhost:7217/api/Login/ChangePassword"}/${user.userId}`, {
                  ...
                  <Form>
                    ...
                    <Row>
                      <Col xs={6} className='align-items-start'>
                        ...
                        <Button variant="primary" className="px-4 " onClick={handleChangePassword} disabled={loading}>
                          {loading ? 'Changing Password...' : 'Change Password'}
                        </Button>
                      </Col>
                      <Col xs={6} className='text-end fs-5'>
                      {/* Reset Password Button */}
                      <Link to="/Login" color="primary" className="px-4" onClick={handleChangePassword}>
                        Login
                      </Link>
                    </Col>
                    </Row>
